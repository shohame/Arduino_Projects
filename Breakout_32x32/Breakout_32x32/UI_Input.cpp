...
void UI_Input::GetKeyStatus(stKeyStatus* a_pKS_Player1, stKeyStatus* a_pKS_Player2)
{
	...
	a_pKS_Player2->m_L = GetAsyncKeyState('a')			?	1 : 0;
	a_pKS_Player2->m_R = GetAsyncKeyState('d')			?	1 : 0;
	a_pKS_Player2->m_U = GetAsyncKeyState('w')			?	1 : 0;
	a_pKS_Player2->m_D = GetAsyncKeyState('x')			?	1 : 0;	
